...
- Installed USharpVideo with Unity > Assets > Import Package > Custom Package...
  ...
  * Later removed by deleting it from `Assets` folder
- Installed ProTV using VCC package management
  * Added repo from https://vpm.techanon.dev/index.json
  * Installed ArchiTech.ProTV version 3.0.0-beta.27
  * Used "Simple" prefab from package
  * Default volume of 0.3 seems fine
  * Check "Start with 2D Audio" for non-spatial background music
